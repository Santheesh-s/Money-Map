  ...
  return (
    <div
      ...
      style={{
        ...
        '--dashboard-shadow': '0 2px 16px 0 rgba(0,0,0,0.07)',
    ...
    >
      <div style={{width: '100%', maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateRows: 'auto auto 1fr auto', gap: 32}}>
        ...
        <div style={{width: '95.8%', background: 'var(--dashboard-card)', borderRadius: 16, boxShadow: 'var(--dashboard-shadow)', padding: 24, margin: '32px 0 0 0'}}>
