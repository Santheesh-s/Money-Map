...
function LayoutWithSidebar({ children }) {
  ...
  // Hide sidebar on public pages (auth and home)
...
function App() {
  ...
  // Helper component to conditionally render ChatBot based on route
  function ChatBotGuard() {
    const location = useLocation();
    if (location.pathname === '/auth' || location.pathname === '/') return null;
    return <ChatBot summary={summary} />;
  }
      ...
      <LayoutWithSidebar>
        ...
        <Routes>
          ...
          <Route path="/history" element={<RequireAuth><TransactionHistory /></RequireAuth>} />
            ...
            <Route path="/budgets" element={<RequireAuth><BudgetManagement /></RequireAuth>} />
